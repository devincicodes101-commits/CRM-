...
export function JobForm({ job, customers, quotes = [] }: Props) {
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="rounded-xl border bg-card p-4 space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="space-y-1.5">
            <Label htmlFor="assigned_team">Assigned Operative/Team</Label>
            <Input id="assigned_team" {...register("assigned_team")} placeholder="Name or team" />
          </div>
          <div className="space-y-1.5">
            <Label htmlFor="assigned_vehicle">Assigned Vehicle</Label>
            <Input id="assigned_vehicle" {...register("assigned_vehicle")} placeholder="Vehicle reg or name" />
          </div>
          <div className="space-y-1.5">
            <Label>Status</Label>
            <Controller
