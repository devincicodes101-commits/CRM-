...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Receipts", href: "/receipts", icon: Receipt, roles: ["admin", "user"] },
  ...
  { label: "AI Tools", href: "/ai-tools", icon: Sparkles, roles: ["admin", "user"] },
  { label: "AI Telesales Agent", href: "/telesales-agent", icon: Bot, roles: ["admin", "user", "telesales", "sales"] },
